    ...
    <div className="h-screen flex flex-col justify-between bg-gray-100">
      ...
      <div className="mb-auto py-10 px-4 bg-gray-100">
        <div className="container mx-auto">
          <h1 className="text-6xl font-black font-bold mb-6 text-center ">
            VectorDB Demo App<small style={{ verticalAlign: 'sub', fontSize:'0.2em' }}>by....  Hariprasath</small>
          </h1>
      ...
      <footer className="justify-center items-center bg-gray-600 text-white h-10 flex">
        Made by &nbsp;<a href="https://x.com/aj__chan/" target="_blank" className="underline text-blue-200">Hariprasath</a> &nbsp; and built with &nbsp;<a target="_blank" href="https://weaviate.io/" className="underline text-blue-200">Weaviate Demo</a>.
      </footer>
    </div>
  );
}
